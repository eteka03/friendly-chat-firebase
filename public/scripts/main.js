...
function signIn() {
  //sign into firebase using popup auth and google as the identity provider.
...
function saveMessage(messageText) {
  ...
  .catch(err =>{
    console.error('error writing new message to firestore',err)
  });
}
...
function loadMessages() {
  ...
  //creat the query to load th last 12 messages and listen for new ones
